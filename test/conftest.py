...
# Make MultiDocChat/src importable
ROOT = pathlib.Path(__file__).resolve().parents[1] / "MultiDocChat" / "src"
...
# os.environ.setdefault("PYTHONPATH", str(pathlib.Path(__file__).resolve().parents[1] / "MultiDocChat"))
...
def stub_model_loader(monkeypatch):
    ...
    from MultiDocChat.utils import model_loader as ml_mod2
    ...
    import MultiDocChat.src.document_ingestion.ingest as di
    import MultiDocChat.src.document_chat.retriver as r
