...
def test_document_ingestion_and_rag():
    try:
        test_files = [
            r"C:\Users\manas\OneDrive\Desktop\multi-doc-chat\data\rag_data.txt",
        ]
        ...
        ci = ChatIngestor(temp_base_file="data", faiss_base_file="faiss_index", use_session_dirs=True)
